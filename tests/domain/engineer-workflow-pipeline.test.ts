...
const actualLogMarkers = {
  uefiEntry: line("UEFI firmware initialization complete"),
  exitBootServices: line("UEFI: ExitBootServices"),
  osBootStart: line("EFI stub: Booting Linux Kernel\\.\\.\\."),
  stressappStart: line("stressapptest: start memory=.*"),
  stressappPass: line("stressapptest PASS"),
  hidagStart: line("HIDAG START mode=(?:DIAG|STRESS) .*"),
  hidagEndPass: line("HIDAG END result=PASS"),
  atPass: line("@PASS"),
  diagOrAtFail: line("DIAG_FAIL\\b.*"),
  testFail: line("HIDAG @FAIL\\b.*"),
  trainingFail: line("TRAINING_FAIL\\b.*"),
  watchdogReset: line("WATCHDOG bite detected"),
  systemReboot: line("SYSTEM_REBOOT"),
  consoleHalted: line("hdiag heartbeat stopped without terminal marker"),
  captureStopped: line("CAPTURE_STOPPED before terminal result"),
  captureAmbiguous: line("UNCLASSIFIED_CAPTURE_END"),
} as const;
...
const ruleTemplates: readonly RuleTemplate[] = [
  {
    ...
    clauses: [
      ...
      { key: "stressapp-start", query: actualLogMarkers.stressappStart, presence: "present", afterKey: "hidag-start" },
      { key: "stressapp-pass", query: actualLogMarkers.stressappPass, presence: "present", afterKey: "stressapp-start" },
      { key: "hidag-end", query: actualLogMarkers.hidagEndPass, presence: "present", afterKey: "stressapp-pass" },
  ...
  },
  {
    ...
    clauses: [
      ...
      { key: "training-fail", query: actualLogMarkers.trainingFail, presence: "present", afterKey: "uefi-entry" },
      { key: "hidag-start", query: actualLogMarkers.hidagStart, presence: "absent" },
      { key: "diag-or-at-fail", query: actualLogMarkers.diagOrAtFail, presence: "absent" },
      { key: "test-fail", query: actualLogMarkers.testFail, presence: "absent" },
      { key: "hidag-end", query: actualLogMarkers.hidagEndPass, presence: "absent" },
      { key: "at-pass", query: actualLogMarkers.atPass, presence: "absent" },
  ...
  },
  {
    ...
    clauses: [
      ...
      { key: "hidag-start", query: actualLogMarkers.hidagStart, presence: "present", afterKey: "os-boot-start" },
      { key: "stressapp-pass", query: actualLogMarkers.stressappPass, presence: "absent" },
