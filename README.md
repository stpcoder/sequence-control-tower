...
한 달 동안 실제 DRAM 평가 업무에 사용한 결과, 평가 1회당 5시간 이상 걸리던 분석 준비와 결과 정리를 10분 미만으로 줄였습니다. 평가 1회당 최소 4시간 50분을 불량 원인 검토, 개선 여부 판단과 다음 평가 결정에 사용할 수 있게 됐습니다. 동료 평가 결과에서도 로그 불러오기, 판정, 조건별 정리와 시각화 전 과정을 10분 미만에 완료했습니다.
