...
export const LPDDR_AGENT_TOOL_DESCRIPTIONS: Record<LpddrAgentToolName, string> = {
  ...
  failure_trends_get: '선택 로그의 확정 Pass/Fail 분모와 저장된 평가 근거를 함께 사용해 SKEW, Die, Sample, 명령, DQ, BL, Channel, Sub Channel, Rank, Bank Group, Bank, Row, Column, Pattern, 주파수, 온도, VDD별 실패 집중도를 계산합니다.'
}
