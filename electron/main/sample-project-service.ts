...
export class SampleProjectService {
  ...
  private async ensureLpddr5Reference(): Promise<void> {
    ...
    reference = await this.deps.projects.save({
      ...
      evaluationNodes: [{ id: 'ref-n-vperi', hypothesisId: 'ref-h-vperi', branchId: 'closed-vperi', name: 'LPDDR5 VPERI DQ9 screening', purpose: 'screening', dimensions: { sku: 'X5-12Gb', material: 'REF-WAF8', dq: 9, pattern: 'WR', temperatureC: 85, vdd: 1.1, testMode: 'VPERI' }, status: 'fail' }],
      evidenceRecords: []
    })
